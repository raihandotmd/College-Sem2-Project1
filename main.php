            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <img src="images/slides/barbell-dumbell.png" alt="Barbell and dumbell set promo" />
                    </div>
                    <div class="swiper-slide">
                        <img src="images/slides/kettlebell.png" alt="kettlebell set promo" />
                    </div>
                    <div class="swiper-slide">
                        <img src="images/slides/jump-rope.png" alt="kettlebell set promo" />
                    </div>
                </div>
    ...
    <section class="container-slide_two">
        <section class="video-intro">
            <div class="video-wrapper">
                <iframe src="https://share.synthesia.io/embeds/videos/0c6d6252-73e1-4e6d-baaa-a6fa81a76566"
                    loading="lazy" title="Synthesia video player - Your AI video" allow="encrypted-media; fullscreen;"
                    class="video-review" style="border: none">
                </iframe>
            </div>
        </section>
                ...
                <div class="review-cards">
                    <div class="container-card col-card">
                        ...
                        <div class="review-authors">
                            <div class="review-author_profile author-content">
                                <img src="images/person1.jpg" alt="Person 1 profile picture"
                                    class="review-author_image" />
                            </div>
                            <div class="review-author_details">
                                <div class="review-author_name author-content">
                                    paul tomlinson
                                </div>
                                <div class="review-author_location author-content">
                                    from canada
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container-card col-card">
                        ...
                        <div class="review-authors">
                            <div class="review-author_profile">
                                <img src="images/person2.jpg" alt="Person 2 profile picture"
                                    class="review-author_image" />
                            </div>
                            <div class="review-author_details">
                    ...
                    <div class="container-card row-card">
                        ...
                        <div class="review-authors">
                            <div class="review-author_profile">
                                <img src="images/person3.jpg" alt="Person 3 profile picture"
                                    class="review-author_image" />
                            </div>
                            <div class="review-author_details">
                                <div class="review-author_name">
                ...
                foreach ($rs as $row) { ?>
                    ...
                    <div class="product-wrapper">
                        <div class="product-picture">
                            <img src="<?= "admin/database/uploads/" . $row['image'] ?>" alt="<?= $row['nama'] ?>"
                                class="product-image" />
                        </div>
        ...
        <div class="contact-container">
            ...
            <div class="contact-form">
                <form>
                    ...
                    <input type="email" id="email name" placeholder="Your E-mail" required />
                    <textarea name="message" id="message" placeholder="Messages max-length 250-char." rows="4"
