                        ...
                        <ul class="list-group mb-3">
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    ...
                                    <small class="text-body-secondary"><?= $row['nama'] ?></small>
                                </div>
                            </li>
                            <li class="list-group-item d-flex justify-content-between lh-sm">
                                <div>
                                    <h6 class="my-0">Product Description</h6>
                                    <small class="text-body-secondary"><?= $row['deskripsi'] ?></small>
                                </div>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                    <span class="my-0">Quantity (max 10)</span>
                                        <div class="quantity-wrapper">
                                            <button type="button" onclick="decrementValue()" style="background-color: transparent;border:0;" >-</button>
                                            <input type="text" name="quantity" value="1" maxlength="2" max="10" size="1" id="quantity" style="width: 2.5em;padding:0em 0.5em;border-radius:0.3em; border:0.5px solid black" />
                                            <button type="button" onclick="incrementValue()" style="background-color: transparent;border:0;" >+</button>
                                        </div>
                            </li>
                            <li class="list-group-item d-flex justify-content-between">
                                <span>Total (USD)</span>
                        ...
                        <h4 class="mb-3">Your Information</h4>
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="lastName" name="address" placeholder="Your Address" value="" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="input-group has-validation">
                                        ...
                                        <input type="number" class="form-control" id="phone_number" name="phone_number" placeholder="Only Numbers"
                                            required>
                                        <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Color Blue, Silver, Black">
                                </div>

                            <hr class="my-4">
                            
                            <input type="hidden" name="produk_id" value="<?= $_GET['id'] ?>">
                            <button class="w-100 btn btn-primary btn-lg" type="submit" name="proses" value="simpan">Continue to checkout</button>
                    </div>
                </div>
            </form>
        </main>
